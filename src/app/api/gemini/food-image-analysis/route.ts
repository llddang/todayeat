...
import { createAiResponses, createAiRequest, getFoodImagesById } from '@/apis/analysis-request.api';
...
export const POST = async (req: Request) => {
  try {
    ...
    const { error: insertError } = await createAiResponses(insertPayload);
