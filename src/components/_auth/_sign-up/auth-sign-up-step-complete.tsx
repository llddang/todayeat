...
const AuthSignUpStepComplete = () => {
  return (
    <div className="absolute left-1/2 top-1/2 flex w-full -translate-x-1/2 -translate-y-1/2 flex-col items-center justify-center gap-9 px-4">
      <div className="before:bg-complete-confetti flex flex-col items-center before:h-20 before:w-20 before:bg-contain before:bg-center before:bg-no-repeat">
...
export default AuthSignUpStepComplete;
