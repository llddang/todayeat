...
const buttonVariants = cva(
  'py-[0.625rem] inline-flex items-center justify-center gap-1 whitespace-nowrap text-sm font-semibold tracking-[-0.02em] leading-[140%] transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none',
  {
    variants: {
      variant: {
        primary:
